...
INSERT INTO Persona (nickname, nombre, dni, correo, domicilio, contrasenha) VALUES ('david_bp', 'David Blanco Peña', '46289271T', 'david.blanco@usc.es', 'Lugar de Penelas, 65, Teo, 15883, A Coruña', 'USC.usc.1234');
INSERT INTO Persona (nickname, nombre, dni, correo, domicilio, contrasenha) VALUES ('quique_ar', 'Quique Alvarez Ramirez', '49277908V', 'quique.alvarez@usc.es', 'Calle Angosto, 78, Jimena, 23530, Jaen ', 'USC.usc.1234');
INSERT INTO Persona (nickname, nombre, dni, correo, domicilio, contrasenha) VALUES ('alejandro_gg', 'Alejandro Garcia Garcia', '54971489V', 'alejandro.garcia@usc.es', 'Antonio, Vazquez, 46, Arona, 38640, Tenerife', 'USC.usc.1234');
INSERT INTO Persona (nickname, nombre, dni, correo, domicilio, contrasenha) VALUES ('marcelo_mf', 'Marcelo Muñoz Fort', '07790503N', 'marcelo.muñoz@usc.es', 'Plaza Colon, 8, Nieva de Cameros, 26124, La Rioja', 'USC.usc.1234');

INSERT INTO Persona (nickname, nombre, dni, correo, domicilio, contrasenha) VALUES ('hamza_lm', 'Hamza Lozano Martinez', '63333716L', 'hamza.lozano@gmail.com', 'C. de la República de El Salvador, 13, Santiago de Compostela, 15701, A Coruña', 'xlBJy$!obNrBv');
INSERT INTO Persona (nickname, nombre, dni, correo, domicilio, contrasenha) VALUES ('denis_rc', 'Denis Riera Camaño', '13348012P', 'denis.riera@gmail.com', 'C. Dos de Mayo, 15, Ponferrada, 24400, León', 'x&L#MNhCYGw+Y');
INSERT INTO Persona (nickname, nombre, dni, correo, domicilio, contrasenha) VALUES ('alfredo_sg', 'Alfredo Seoane Gomez', '07996160A', 'alfredor.seoane@gmail.com', 'C. de Manuel Gómez Oria, 6, Alcobendas, 28100, Madrid', ',eJ@yhpV]%E}(');
INSERT INTO Persona (nickname, nombre, dni, correo, domicilio, contrasenha) VALUES ('judith_mm', 'Judith Miguez Menendez', '83807237K', 'judith.miguez@gmail.com', 'C. de Gómez de Baquero, 18, Centro, 28004, Madrid', '+Q6Aph@on~Tw#');

INSERT INTO Persona (nickname, nombre, dni, correo, domicilio, contrasenha) VALUES ('gemma_sn', 'Gemma Serrano Narvaez', '27467279N', 'gemma.serrano@gmail.com', 'C. de Girona, 83, L`Eixample, 08009, Barcelona', 'e((52u6x.fxw');
INSERT INTO Persona (nickname, nombre, dni, correo, domicilio, contrasenha) VALUES ('gustavo_cg', 'Gustavo Cid Gutierrez', '73445223J', 'gustavo.cid@gmail.com', 'C. Juan XXIII, 12, L`Hospitalet de Llobregat, 08901, Barcelona', 'Q&d3gfldgzK8q');
INSERT INTO Persona (nickname, nombre, dni, correo, domicilio, contrasenha) VALUES ('maria_gt', 'Maria Gloria Tejo', '01474923W', 'maria.gloria@gmail.com', 'C. de Millares, 8, Jesús, 46007, Valencia', ',csA,T.n^VapF');
INSERT INTO Persona (nickname, nombre, dni, correo, domicilio, contrasenha) VALUES ('pablo_tl', 'Pablo Trillo Louzao', '17316116Z', 'pablo.trillo@gmail.com', 'C. Echegaray, 1, Nervión, 41005 Sevilla', 'vCBc5LEHOE;kD');
INSERT INTO Persona (nickname, nombre, dni, correo, domicilio, contrasenha) VALUES ('edgar_mn', 'Edgar Moreno Navarro', '28812101R', 'edgar.moreno@gmail.com', 'C. Sta. Justa, 5, Centro, Gijón, 33208, Asturias', 'Ks!KL$kLBl}+c');
